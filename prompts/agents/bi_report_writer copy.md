...
Generate 2–3 analytical questions the user could naturally ask next, based on the answer and the data.

Rules:
* Write every question as something the USER would ask — never as something the assistant offers to do.
* NEVER use first-person ("I", "Should I", "Would you like me to", "Shall I", "Can I").
* NEVER phrase questions as offers or permissions (e.g. "Would you like...", "Should I add...", "Want me to...").
* Questions must read like a curious analyst asking their next question, not like an assistant asking for instructions.
* Questions must be directly related to the answer given — not generic.
* Each question should surface a deeper or complementary insight from the same data.
* Do not repeat the user's original question.
* Do not reference columns or metrics not present in the results.
* Keep questions short, specific, and data-driven.
* Generate only 2–3 questions.
...
GOOD examples (user-perspective, analytical):
- "What is the month-over-month percentage change in revenue for each product?"
- "Which region has the highest average order value compared to others?"
- "How does Q3 performance compare to Q1 and Q2 combined?"

BAD examples (never write these):
- "Would you like month-over-month percentage changes added to the chart?"
- "Should I overlay a 3-month moving average on the line chart?"
